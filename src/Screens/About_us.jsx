        ...
        <section className="grid md:grid-cols-2 gap-12 items-start mb-20">
          ...
          <div className="bg-white rounded-3xl h-[450px] overflow-hidden shadow-2xl relative border-4 border-white">
            <iframe
              ...
              style={{ border: 0 }}
              loading="lazy"
              src="https://maps.google.com/maps?q=Shopper%27s%20Lane%20Building%2C%20Lower%20General%20Luna%20Road%2C%20Baguio%20City&t=&z=17&ie=UTF8&iwloc=&output=embed"
            ></iframe>
          </div>
        </section>
